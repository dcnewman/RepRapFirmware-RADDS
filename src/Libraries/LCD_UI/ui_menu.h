...
UI_PAGE4(ui_page1,
		 ...
		 "%os");
#endif // DHEATERS >= 2
//UI_PAGE3(ui_page1, UI_TEXT_PAGE_EXTRUDER, UI_TEXT_PAGE_BED, "%os");
...
// How many pages do you want to have. Minimum is 1.
#define UI_NUM_PAGES 3
#endif // (UI_ROWS >= 6) && (UI_DISPLAY_TYPE == 5)


/* ============ MENU definition ================

The menu works the same as pages. In addition you need to define what the lines do
...
#define UI_MENU_POSITIONS {										\
			 UI_MENU_ADDCONDBACK								\
				 ...
				 &ui_menu_go_zpos,								\
				 &ui_menu_go_epos}
UI_MENU(ui_menu_positions, UI_MENU_POSITIONS, 5 + 3 + UI_MENU_BACKCNT);
...
#define UI_MENU_QUICK {												\
			 UI_MENU_ADDCONDBACK									\
				 ...
				 UI_TOOGLE_LIGHT_ENTRY,								\
				 &ui_menu_quick_cooldown,							\
				 &ui_menu_quick_origin,								\
				 &ui_menu_quick_stopstepper							\
				 MENU_PSON_ENTRY}
UI_MENU(ui_menu_quick, UI_MENU_QUICK, 6 + BABY_CNT + UI_MENU_BACKCNT + MENU_PSON_COUNT + UI_TOGGLE_LIGHT_COUNT);
...
UI_MENU_CHANGEACTION(ui_menu_accel_x,    UI_TEXT_ACCEL_X, UI_ACTION_ACCEL_X);
UI_MENU_CHANGEACTION(ui_menu_accel_y,    UI_TEXT_ACCEL_Y, UI_ACTION_ACCEL_Y);
UI_MENU_CHANGEACTION(ui_menu_accel_z,    UI_TEXT_ACCEL_Z, UI_ACTION_ACCEL_Z);
UI_MENU_CHANGEACTION(ui_menu_accel_dvx,  UI_TEXT_DV_X,    UI_ACTION_INSTANT_DV_X);
UI_MENU_CHANGEACTION(ui_menu_accel_dvy,  UI_TEXT_DV_Y,    UI_ACTION_INSTANT_DV_Y);
UI_MENU_CHANGEACTION(ui_menu_accel_dvz,  UI_TEXT_DV_Z,    UI_ACTION_INSTANT_DV_Z);
#define UI_MENU_ACCEL {									\
			 UI_MENU_ADDCONDBACK						\
				 ...
				 &ui_menu_accel_dvy,					\
				 &ui_menu_accel_dvz}
UI_MENU(ui_menu_accel, UI_MENU_ACCEL, 6 + UI_MENU_BACKCNT);
...
#define UI_MENU_FEEDRATE {									\
			 UI_MENU_ADDCONDBACK							\
				 &ui_menu_feedrate_maxx,					\
				 &ui_menu_feedrate_maxy,					\
				 &ui_menu_feedrate_maxz}
UI_MENU(ui_menu_feedrate, UI_MENU_FEEDRATE, 3 + UI_MENU_BACKCNT);
...
UI_MENU(ui_menu_general, UI_MENU_GENERAL, 1 + UI_MENU_BACKCNT);

// **** Extruder configuration

UI_MENU_CHANGEACTION(ui_menu_cext_steps,          UI_TEXT_EXTR_STEPS,              UI_ACTION_STEPS_E);
UI_MENU_CHANGEACTION(ui_menu_cext_max_feedrate,   UI_TEXT_EXTR_MAX_FEED,           UI_ACTION_MAX_FEEDRATE_E);
UI_MENU_CHANGEACTION(ui_menu_cext_acceleration,   UI_TEXT_EXTR_ACCEL,              UI_ACTION_ACCEL_E);
UI_MENU_CHANGEACTION(ui_menu_cext_elasticcomp,    UI_TEXT_ELASTIC_COMP,            UI_ACTION_ADVANCE_K);
...
UI_MENU_CHANGEACTION(ui_menu_cext_pmin,    UI_TEXT_EXTR_PMIN,    UI_ACTION_PID_MIN);
...
UI_MENU(ui_menu_cextr, UI_MENU_CEXTR, 9 + UI_MENU_BACKCNT + UI_MENU_CONFEXTCNT );
...
#define UI_MENU_CONFIGURATION {					\
			 UI_MENU_ADDCONDBACK				\
				 &ui_menu_conf_general,			\
				 &ui_menu_conf_accel,			\
				 &ui_menu_conf_feed,			\
				 &ui_menu_conf_extr				\
				 UI_MENU_SL_COND}
UI_MENU(ui_menu_configuration, UI_MENU_CONFIGURATION, UI_MENU_BACKCNT + UI_MENU_SL_CNT + 4);
...
UI_MENU_SUBMENU(ui_menu_main4, UI_TEXT_CONFIGURATION,  ui_menu_configuration);
#define UI_MENU_MAIN {												\
			 UI_MENU_ADDCONDBACK									\
				 &ui_menu_main1,									\
				 SD_PRINTFILE_ENTRY									\
				 ...
				 &ui_menu_sd_sub,									\
				 &ui_menu_main4}
UI_MENU(ui_menu_main, UI_MENU_MAIN, 4 + UI_MENU_BACKCNT + 1 + UI_MENU_FAN_CNT + SD_PRINTFILE_ENTRY_CNT);
