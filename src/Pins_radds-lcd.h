...
#define DHEATERS 4 // Needed for LCD support
const int8_t HEATERS = DHEATERS;
...
const int8_t END_STOP_PINS[DRIVES] = { 28, 30, 32, -1, -1, -1, -1, -1 };
...
#define ATX_POWER_PIN_D 40 // Needed for LCD support
const Pin ATX_POWER = ATX_POWER_PIN_D;
...
#define COOLING_FAN0_PIN 9 // Needed for LCD support

const size_t NUM_FANS = 2;
const Pin COOLING_FAN_PINS[NUM_FANS] = { COOLING_FAN0_PIN, 8 }; // Fan 0, Fan 1
